...
namespace OVRTouchSample
{
    ...
    // TFR EDIT
    [RequireComponent(typeof(TFRHandScript))]
    ...
    public class Hand : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool m_useFixedJointForGrabbedObject = true;
        ...
        private void Start()
        {
            ...
            // TFR EDIT
            if (m_TFRHandScript == null)
                m_TFRHandScript = GetComponent<TFRHandScript>();
        }
        ...
        private void UpdateAnimStates()
        {
            ...
            // Point
            bool canPoint = m_grabbedObj == null || GrabPose.AllowPointing;
            float point = canPoint ? m_point : 0.0f;
            m_animator.SetLayerWeight(m_animLayerIndexPoint, point);
            // TFR Edit
            if (point > 0.0f)
            {
                m_TFRHandScript.m_IsPointing = true;
            }
            else
            {
                m_TFRHandScript.m_IsPointing = false;
            }

            // Thumbs up
            bool canThumbsUp = m_grabbedObj != null || GrabPose.AllowThumbsUp;
        ...
        private void GrabEnd()
        {
            ...
            // TFR Edit
            m_TFRHandScript.m_GrabbedObject = null;
        }
